...
class TfPoseEstimator:
    ...
    def __init__(self, graph_path, target_size=(320, 240), tf_config=None):
        ...
        with open(graph_path, 'rb') as fln:
            graph_def = tf.compat.v1.GraphDef()
            graph_def.ParseFromString(fln.read())
        ...
        #    print(ts)
        tensor_name = 'image:0'  # Assuming 'image' is the correct tensor name
        tensor_name_with_scope = 'TfPoseEstimator/' + tensor_name
        self.tensor_image = self.graph.get_tensor_by_name(tensor_name_with_scope)
